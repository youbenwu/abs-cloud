...
@ApiModel(value = "WarehouseVO", description = "仓库详细信息")
@JsonInclude(value= JsonInclude.Include.NON_NULL)
public class WarehouseVO implements DslVO<QWarehouse> {
     ...
     *
     * */
    @ApiModelProperty(name = "user", value = "创建用户")
    ...
    @ApiModelProperty(name = "manager", value = "管理员")
    private ContactUserVO manager;
    ...
    @ApiModelProperty(name = "subs", value = "成员子仓库列表")
    ...
    public static Expression<?>[] select(QWarehouse e){
        return ArrayUtil.merge(
                ...
                new Expression<?>[]{
                        e.id,e.manager.id,e.status,e.name,e.warehouseNo,e.themeImage,e.themeColor,
    ...
    @Override
    public WarehouseVO fromTuple(Tuple t, QWarehouse e) {
    ...
    public ContactUserVO getManager() {
        return manager;
    }

    public void setManager(ContactUserVO manager) {
    ...
    public List<WarehouseMaterialVO> getMaterials() {
        return materials;
    }

    public void setMaterials(List<WarehouseMaterialVO> materials) {
