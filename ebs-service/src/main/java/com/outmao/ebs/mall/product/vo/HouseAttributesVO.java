...
@ApiModel(value = "HouseAttributesVO", description = "房源参数")
@JsonInclude(value = JsonInclude.Include.NON_NULL)
@Data
public class HouseAttributesVO {


    @ApiModelProperty(name = "houseDistrict", value = "房子地区,用于在列表中显示 如：白云 白云智慧城")
    private String houseDistrict;

    @ApiModelProperty(name = "houseArea", value = "房屋面积,用于在列表中显示 如：建面112-140m²")
    private String houseArea;

    @ApiModelProperty(name = "doorModel", value = "户型，用于在列表中显示 如：1房1厅")
