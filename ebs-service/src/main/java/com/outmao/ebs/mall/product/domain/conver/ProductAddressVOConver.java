...
import com.outmao.ebs.mall.product.entity.QProductAddress;
import com.outmao.ebs.mall.product.vo.ProductAddressVO;
import com.querydsl.core.Tuple;
import com.querydsl.core.types.Expression;

public class ProductAddressVOConver implements BeanConver<QProductAddress, ProductAddressVO> {


    @Override
    public ProductAddressVO fromTuple(Tuple t, QProductAddress e) {
    ...
    @Override
    public Expression<?>[] select(QProductAddress e) {
